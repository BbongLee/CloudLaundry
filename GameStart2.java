...
public class GameStart2 extends JFrame{
	...
	public void insertCloudImage(){
		for(int i=0; i<5; i++) {
			str[i] = new ImageIcon(Main.class.getResource(i+".png"));
		}
	}
//	ImageIcon str = new ImageIcon("CloudClean1.png");
//	JLabel cloud = new JLabel(str);
	JLabel clouds[] = new JLabel[20];
	public void insertCloudLabel(){
		clouds[0] = new JLabel(str[0]);
		//랜덤 구름 넣어주기
		for(int i=0; i<20; i++) {
			clouds[i] = new JLabel(str[(int)(Math.random()*5)]);
		}
	}
	...
	public void insertXY(){
		...
		for(int i=0; i<20; i++) {
			x = 0;
			switch((int)(i%4)) {
			case 0:case 4:case 8:case 12:case 16: x=0; System.out.println(x); break;
			case 1:case 5:case 9:case 13:case 17: x=1;System.out.println(x);break;
			case 2:case 6:case 10:case 14:case 18: x=2;System.out.println(x); break;
			case 3:case 7:case 11:case 15:case 19: x=3;System.out.println(x);  break;
			default: System.out.println("좌표생성 에러!");System.out.println(x); break;
			}
